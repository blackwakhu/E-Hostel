import { hideDivElements, hideUrlDivElements, hideEditElements, validateNumber, handleUpdateClick } from "./mymodules.js";
    ...
    updateElementsOwner.forEach((elem) => {
        ...
        elem.subbtn.addEventListener("click", () => {
            ...
            if (elem.column === "phone_number" && !(validateNumber(elem.inputElem.value))) {
                ...
                const elemurl = `/api/owner/update/${uname}/${elem.column}/`;
