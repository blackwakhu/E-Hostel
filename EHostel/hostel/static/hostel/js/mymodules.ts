...
export function hideDivElements(
  btn: HTMLAnchorElement,
  buttons: HTMLAnchorElement[],
  seeDiv: HTMLDivElement,
...
export function hideBookDiv(div: HTMLDivElement, elems: HTMLDivElement[]) {
  elems.forEach(elem => {
    if (elem.classList.contains("hide-elem")) { }
    else {elem.classList.add("hide-elem")}
  })
  div.classList.remove("hide-elem")
}

export function hideUrlDivElements(
...
export function hideEditElements(
  btn: HTMLButtonElement,
  visibleClass: HTMLSpanElement,
  hideClass: HTMLSpanElement,
  extBtn: HTMLButtonElement,
  classStr: string
) {
